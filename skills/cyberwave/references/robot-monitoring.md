...
simulation views. It is not temperature data or evidence of a thermal anomaly;
raw camera captures remain RGB. Do not infer temperatures from the displayed
palette or claim thermal hardware/simulation support from this effect.
